...
public class BaseTest {
	...
	/**
	 * Initializes the WebDriver instance before each test method. Opens the browser
	 * specified by the 'browser' parameter (defaults to Chrome) and navigates to
	 * the application URL from properties.
	 * 
	 * @param browser      Browser type ("chrome", "firefox", etc.), optional with
	 *                     default "chrome".
	 * @param headlessmode Flag indicating if browser should run in headless mode.
	 */
	@Parameters({ "browser", "headlessmode" })
	@BeforeMethod(alwaysRun = true)
	public void setUpDriver(@Optional("chrome") String browser, @Optional("false") String headlessmode) {
